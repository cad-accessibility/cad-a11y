...
from OCC.Core.Quantity import Quantity_NOC_BLACK, Quantity_NOC_RED
...
def create_orthographic_views(step_file):
    ...
    for view_key in views.keys():
        ...
        write_svg_lines(os.path.join("svg_views", view_key+"_all_edges.svg"), all_edges, width=800, height=800)

if __name__ == '__main__':
    create_orthographic_views(os.path.join("..", "models", "brep", "thumb_top.step"))