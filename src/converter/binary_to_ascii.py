...
def execute(file):
    ...
    # Joanna: Check if already ASCII - return the file itself if it is already in ASCII

    if _is_ascii_stl(file):
    ...
    # Joanna: Read binary STL - change this function here because it is still using the file path
    ...
    # Joanna: Write ASCII STL - instead of write convert file and return converted files so it can

    # be assigned in upload_ model
